...
| [`calibrax.metrics`](../api-reference/metrics/index.md) | 4-tier metric system with 132 registered Tier 0 metrics across 20 domains plus Tier 1-3 APIs and losses |
