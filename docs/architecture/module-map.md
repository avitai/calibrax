...
| `metrics` | `functional/` (20 domains), `stateful/`, `learning/`, `plugins/`, `composition`, `wrappers`, `_registry` | 132 registered | 4-tier metric system: pure functions, frozen backbone, learned (NNX), metric learning losses; registry with axiom-based discovery |
