...
- Extensible metrics framework (139 registered Tier 0 metrics plus Tier 1-3 APIs, optional plugins, and metric-learning losses)
...
adding 139 registered Tier 0 metrics across 20 functional domains, plus Tier 1-3
