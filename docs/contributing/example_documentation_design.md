...
- Extensible metrics framework (140 registered Tier 0 metrics plus Tier 1-3 APIs, optional plugins, and metric-learning losses)
...
adding 140 registered Tier 0 metrics across 20 functional domains, plus Tier 1-3
